...
class CardAdmin(admin.ModelAdmin):
    ...
    def get_object(self, request, object_id, from_field=None):
        ...
        request.card_obj = obj
        return obj

    def formfield_for_manytomany(self, db_field, request, **kwargs):
        if (
            db_field.name == "enabled_archetypes"
            or db_field.name == "payed_off_archetypes"
        ) and hasattr(request, "card_obj"):
            kwargs["queryset"] = Archetype.objects.order_by("name")
